...
def test_07_08_09_10_26(fixture_test_07_08_09_10_26):
    ...
    if st.get_ui_type(data.dut2) != "click":
        skp_err = False
    else:
        skp_err = True
    if ip_obj.config_ip_addr_interface(data.dut2, dut2_loopback[0], dut2_loopback_ip[2], ip_loopback_prefix,'ipv4', 'add',skp_err, is_secondary_ip="yes"):
