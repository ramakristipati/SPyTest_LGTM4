...
def dut1_config(config = ''):
    ...
    ip_obj.config_ip_addr_interface(data.dut1_client, data.d1_d2_ports[0], data.dut1_dut2_ip[0], data.dut1_dut2_ip_subnet,'ipv4')
    ...
    vlan_obj.add_vlan_member(data.dut1_client,data.dut1_dut2_vlan[0],data.d1_d2_ports[1],True,True)
    ip_obj.config_ip_addr_interface(data.dut1_client, 'Vlan'+data.dut1_dut2_vlan[0], data.dut1_dut2_ipv6[1], data.dut1_dut2_ipv6_subnet,'ipv6')
    ip_obj.config_ip_addr_interface(data.dut1_client, 'Vlan'+data.dut1_dut2_vlan[0], data.dut1_dut2_ip[1], data.dut1_dut2_ip_subnet,'ipv4')
    ...
    pc_obj.add_portchannel_member(data.dut1_client, data.portchannel,[data.d1_d2_ports[2],data.d1_d2_ports[3]])
    ip_obj.config_ip_addr_interface(data.dut1_client, data.portchannel, data.dut1_dut2_ipv6[2], data.dut1_dut2_ipv6_subnet,'ipv6')
    ip_obj.config_ip_addr_interface(data.dut1_client, data.portchannel, data.dut1_dut2_ip[2], data.dut1_dut2_ip_subnet,'ipv4')

    st.log('On DUT1 configure loopback and IPv4 and IPv6 addresses on it')
    ip_obj.configure_loopback(data.dut1_client, config = 'yes', loopback_name = data.dut1_loopback[0])
    ip_obj.config_ip_addr_interface(data.dut1_client, data.dut1_loopback[0], data.dut1_loopback_ipv6[0], data.dut1_loopback_ipv6_subnet,'ipv6')
    ip_obj.config_ip_addr_interface(data.dut1_client, data.dut1_loopback[0], data.dut1_loopback_ip[0], data.dut1_loopback_ip_subnet,'ipv4')
...
def dut1_unconfig(config = ''):
    ...
    ip_obj.delete_ip_interface(data.dut1_client, data.dut1_loopback[0], data.dut1_loopback_ipv6[0], data.dut1_loopback_ipv6_subnet,'ipv6')
    ip_obj.delete_ip_interface(data.dut1_client, data.dut1_loopback[0], data.dut1_loopback_ip[0], data.dut1_loopback_ip_subnet,'ipv4')
    ip_obj.configure_loopback(data.dut1_client, config = 'no', loopback_name = data.dut1_loopback[0])
    ...
    ip_obj.delete_ip_interface(data.dut1_client, data.portchannel, data.dut1_dut2_ip[2], data.dut1_dut2_ip_subnet,'ipv4')
    ...
    ip_obj.delete_ip_interface(data.dut1_client, 'Vlan'+data.dut1_dut2_vlan[0], data.dut1_dut2_ipv6[1], data.dut1_dut2_ipv6_subnet,'ipv6')
    ip_obj.delete_ip_interface(data.dut1_client, 'Vlan'+data.dut1_dut2_vlan[0], data.dut1_dut2_ip[1], data.dut1_dut2_ip_subnet,'ipv4')
    vlan_obj.delete_vlan_member(data.dut1_client,data.dut1_dut2_vlan[0],data.d1_d2_ports[1],True)
    vlan_obj.create_vlan(data.dut1_client, data.dut1_dut2_vlan[0])
    ...
    ip_obj.delete_ip_interface(data.dut1_client, data.d1_d2_ports[0], data.dut1_dut2_ip[0], data.dut1_dut2_ip_subnet,'ipv4')

    st.log('Unconfigure IPv6 address on management interface of DUT1')
    ip_obj.delete_ip_interface(data.dut1_client, data.mgmt_intf, data.dut1_mgmt_ipv6[0], data.dut1_mgmt_ipv6_subnet,'ipv6')
...
def dut2_config(config = ''):
    ...
    ip_obj.config_ip_addr_interface(data.dut2_server, data.d2_d1_ports[0], data.dut2_dut1_ipv6[0], data.dut2_dut1_ipv6_subnet, 'ipv6')
    ip_obj.config_ip_addr_interface(data.dut2_server, data.d2_d1_ports[0], data.dut2_dut1_ip[0], data.dut2_dut1_ip_subnet, 'ipv4')
    ...
    vlan_obj.add_vlan_member(data.dut2_server,data.dut1_dut2_vlan[0], data.d2_d1_ports[1],True,True)
    ip_obj.config_ip_addr_interface(data.dut2_server, 'Vlan'+data.dut1_dut2_vlan[0], data.dut2_dut1_ipv6[1], data.dut2_dut1_ipv6_subnet, 'ipv6')
    ip_obj.config_ip_addr_interface(data.dut2_server, 'Vlan'+data.dut1_dut2_vlan[0], data.dut2_dut1_ip[1], data.dut2_dut1_ip_subnet, 'ipv4')
    ...
    pc_obj.add_portchannel_member(data.dut2_server, data.portchannel,[data.d2_d1_ports[2],data.d2_d1_ports[3]])
    ip_obj.config_ip_addr_interface(data.dut2_server, data.portchannel, data.dut2_dut1_ipv6[2], data.dut2_dut1_ipv6_subnet, 'ipv6')
    ip_obj.config_ip_addr_interface(data.dut2_server, data.portchannel, data.dut2_dut1_ip[2], data.dut2_dut1_ip_subnet, 'ipv4')

    st.log('On DUT2 configure loopback and add IPv4 and IPv6 addresses to it')
    ip_obj.configure_loopback(data.dut2_server, config = 'yes', loopback_name = data.dut2_loopback[0])
    ip_obj.config_ip_addr_interface(data.dut2_server, data.dut2_loopback[0], data.dut2_loopback_ipv6[0], data.dut2_loopback_ipv6_subnet,'ipv6')
    ip_obj.config_ip_addr_interface(data.dut2_server, data.dut2_loopback[0], data.dut2_loopback_ip[0], data.dut2_loopback_ip_subnet,'ipv4')
    ...
    vlan_obj.add_vlan_member(data.dut2_server,data.dut2_dut3_vlan[0], data.d2_d3_ports[1],True,True)
    ip_obj.config_ip_addr_interface(data.dut2_server, 'Vlan'+data.dut2_dut3_vlan[0], data.dut2_dut3_ipv6[1], data.dut2_dut3_ipv6_subnet, 'ipv6')
    ip_obj.config_ip_addr_interface(data.dut2_server, 'Vlan'+data.dut2_dut3_vlan[0], data.dut2_dut3_ip[1], data.dut2_dut3_ip_subnet, 'ipv4')
    ...
    pc_obj.add_portchannel_member(data.dut2_server, data.portchannel_2,[data.d2_d3_ports[2],data.d2_d3_ports[3]])
    ip_obj.config_ip_addr_interface(data.dut2_server, data.portchannel_2, data.dut2_dut3_ipv6[2], data.dut2_dut3_ipv6_subnet,'ipv6')
    ip_obj.config_ip_addr_interface(data.dut2_server, data.portchannel_2, data.dut2_dut3_ip[2], data.dut2_dut3_ip_subnet,'ipv4')

    st.log('On DUT2 configure loopback and IPv4 and IPv6 addresses on it')
    ip_obj.configure_loopback(data.dut2_server, config = 'yes', loopback_name = data.dut2_loopback[1])
    ip_obj.config_ip_addr_interface(data.dut2_server, data.dut2_loopback[1], data.dut2_loopback_ipv6[1], data.dut2_loopback_ipv6_subnet,'ipv6')
    ip_obj.config_ip_addr_interface(data.dut2_server, data.dut2_loopback[1], data.dut2_loopback_ip[1], data.dut2_loopback_ip_subnet,'ipv4')
...
def dut2_unconfig(config = ''):
    ...
    ip_obj.delete_ip_interface(data.dut2_server, data.dut2_loopback[0], data.dut2_loopback_ipv6[0], data.dut2_loopback_ipv6_subnet,'ipv6')
    ip_obj.delete_ip_interface(data.dut2_server, data.dut2_loopback[0], data.dut2_loopback_ip[0], data.dut2_loopback_ip_subnet,'ipv4')
    ip_obj.configure_loopback(data.dut2_server, config = 'no', loopback_name = data.dut2_loopback[0])

    st.log('On DUT2 unconfigure portchannel and remove IPv4 and IPv6 addresses on it')
    ip_obj.delete_ip_interface(data.dut2_server, data.portchannel, data.dut2_dut1_ipv6[2], data.dut2_dut1_ipv6_subnet, 'ipv6')
    ip_obj.delete_ip_interface(data.dut2_server, data.portchannel, data.dut2_dut1_ip[2], data.dut2_dut1_ip_subnet, 'ipv4')
    pc_obj.add_del_portchannel_member(data.dut2_server, data.portchannel,[data.d2_d1_ports[2],data.d2_d1_ports[3]],'del')
    ...
    ip_obj.delete_ip_interface(data.dut2_server, 'Vlan'+data.dut1_dut2_vlan[0], data.dut2_dut1_ipv6[1], data.dut2_dut1_ipv6_subnet, 'ipv6')
    ip_obj.delete_ip_interface(data.dut2_server, 'Vlan'+data.dut1_dut2_vlan[0], data.dut2_dut1_ip[1], data.dut2_dut1_ip_subnet, 'ipv4')
    vlan_obj.delete_vlan_member(data.dut2_server,data.dut1_dut2_vlan[0], data.d2_d1_ports[1],True)
    ...
    ip_obj.delete_ip_interface(data.dut2_server, data.d2_d1_ports[0], data.dut2_dut1_ipv6[0], data.dut2_dut1_ipv6_subnet, 'ipv6')
    ip_obj.delete_ip_interface(data.dut2_server, data.d2_d1_ports[0], data.dut2_dut1_ip[0], data.dut2_dut1_ip_subnet, 'ipv4')
...
def dut3_config(config = ''):
    ...
    ip_obj.config_ip_addr_interface(data.dut3_client, data.d3_d2_ports[0], data.dut3_dut2_ipv6[0], data.dut3_dut2_ipv6_subnet,'ipv6')
    ip_obj.config_ip_addr_interface(data.dut3_client, data.d3_d2_ports[0], data.dut3_dut2_ip[0], data.dut3_dut2_ip_subnet,'ipv4')
    vlan_obj.create_vlan(data.dut3_client, data.dut2_dut3_vlan[0])
    vlan_obj.add_vlan_member(data.dut3_client,data.dut2_dut3_vlan[0],data.d3_d2_ports[1],True,True)
    ...
    ip_obj.config_ip_addr_interface(data.dut3_client, 'Vlan'+data.dut2_dut3_vlan[0], data.dut3_dut2_ipv6[1], data.dut3_dut2_ipv6_subnet,'ipv6')
    ip_obj.config_ip_addr_interface(data.dut3_client, 'Vlan'+data.dut2_dut3_vlan[0], data.dut3_dut2_ip[1], data.dut3_dut2_ip_subnet,'ipv4')
    ...
    pc_obj.add_portchannel_member(data.dut3_client, data.portchannel_2,[data.d3_d2_ports[2],data.d3_d2_ports[3]])
    ...
    ip_obj.config_ip_addr_interface(data.dut3_client, data.portchannel_2, data.dut3_dut2_ip[2], data.dut3_dut2_ip_subnet,'ipv4')

    st.log('On DUT3 configure loopback and IPv4 and IPv6 addresses on it')
    ip_obj.configure_loopback(data.dut3_client, config = 'yes', loopback_name = data.dut3_loopback[1])
    vrf_obj.config_vrf(dut = data.dut3_client, vrf_name = data.dut3_vrf_phy, config = 'yes')
    vrf_obj.bind_vrf_interface(dut = data.dut3_client, vrf_name = data.dut3_vrf_phy, intf_name = data.dut3_loopback[1], config = 'yes')
    ip_obj.config_ip_addr_interface(data.dut3_client, data.dut3_loopback[1], data.dut3_loopback_ipv6[1], data.dut3_loopback_ipv6_subnet,'ipv6')
    ip_obj.config_ip_addr_interface(data.dut3_client, data.dut3_loopback[1], data.dut3_loopback_ip[1], data.dut3_loopback_ip_subnet,'ipv4')
